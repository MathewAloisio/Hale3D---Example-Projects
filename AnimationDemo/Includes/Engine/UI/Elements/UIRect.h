...
/----------------------------------*/
#ifndef HALE3D_UI_ELEMENT_RECT
#define HALE3D_UI_ELEMENT_RECT
...
namespace Hale3D {
	class UIRect : public UIElement { //lua
	public:
		UIRect(const Vector2& pUpperLeft, float pWidth, float pHeight, const Color4& pColor = Color4(0, 0, 0, 255)); //lua
		UIRect(const Vector2& pUpperLeft, const Vector2& pLowerRight, const Color4& pColor = Color4(0, 0, 0, 255)); //lua
