...
/----------------------------------*/
#ifndef HALE3D_EXTERNAL_VKRENDERER
#define HALE3D_EXTERNAL_VKRENDERER
#pragma once

/* Hale3D include(s). */
#include "Engine/Rendering/Renderer.h"

/* Include vulkan header(s). */
...
namespace Hale3D {
	...
	public:
		...
		virtual void DrawRectangle(const RectanglePoints& pPoints, const Color4& pColor, BaseTexture* pTexture, bool pFill = true, float pRotationDeg = 0.f);
		virtual void DrawRoundedRectangle(const Vector2& pUpperLeft, const Vector2& pLowerRight, const float pRadiuses[4], const Color4& pColor, BaseTexture* pTexture = nullptr, bool pFill = true);
